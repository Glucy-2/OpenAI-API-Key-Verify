...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.queryGroupBox.setObjectName(u"queryGroupBox")
        ...
        self.doNotQuerySucceededChkBox.setObjectName(u"doNotQuerySucceededChkBox")
        ...
        self.queryProgressBar.setObjectName(u"queryProgressBar")
        ...
        sizePolicy1.setHeightForWidth(self.dataGroupBox.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setHeightForWidth(self.importFileBtn.sizePolicy().hasHeightForWidth())
        ...
        self.exportFileBtn.setObjectName(u"exportFileBtn")
        sizePolicy.setHeightForWidth(self.exportFileBtn.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy2.setHeightForWidth(self.settingsGroupBox.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"OpenAI-API-Key-Verify by Glucy2", None))
        self.queryGroupBox.setTitle(QCoreApplication.translate("MainWindow", u"\u67e5\u8be2", None))
        self.stopBtn.setText(QCoreApplication.translate("MainWindow", u"\u505c\u6b62", None))
        self.startBtn.setText(QCoreApplication.translate("MainWindow", u"\u5f00\u59cb", None))
        self.doNotQuerySucceededChkBox.setText(QCoreApplication.translate("MainWindow", u"\u5df2\u67e5\u8be2\u6210\u529f\u7684\u4e0d\u518d\u67e5\u8be2", None))
        self.queryProgressBar.setFormat(QCoreApplication.translate("MainWindow", u"%v/%m", None))
        self.dataGroupBox.setTitle(QCoreApplication.translate("MainWindow", u"\u6570\u636e", None))
        ___qtablewidgetitem = self.dataTable.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("MainWindow", u"\u5bc6\u94a5", None));
        ___qtablewidgetitem1 = self.dataTable.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MainWindow", u"\u67e5\u8be2\u72b6\u6001", None));
        ___qtablewidgetitem2 = self.dataTable.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", u"\u9519\u8bef\u4fe1\u606f", None));
        ___qtablewidgetitem3 = self.dataTable.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MainWindow", u"\u5bc6\u94a5\u67e5\u8be2\u7ed3\u679c", None));
        ___qtablewidgetitem4 = self.dataTable.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("MainWindow", u"\u5230\u671f\u65f6\u95f4", None));
        ___qtablewidgetitem5 = self.dataTable.horizontalHeaderItem(5)
        ___qtablewidgetitem5.setText(QCoreApplication.translate("MainWindow", u"\u9650\u989d\uff08USD\uff09", None));
        ___qtablewidgetitem6 = self.dataTable.horizontalHeaderItem(6)
        ___qtablewidgetitem6.setText(QCoreApplication.translate("MainWindow", u"100\u5929\u5185\u4f7f\u7528\u989d\u5ea6\uff08USD\uff09", None));
        ___qtablewidgetitem7 = self.dataTable.horizontalHeaderItem(7)
        ___qtablewidgetitem7.setText(QCoreApplication.translate("MainWindow", u"\u5f53\u524d\u8ba1\u5212", None));
        ___qtablewidgetitem8 = self.dataTable.horizontalHeaderItem(8)
        ___qtablewidgetitem8.setText(QCoreApplication.translate("MainWindow", u"GPT4", None));
        ___qtablewidgetitem9 = self.dataTable.horizontalHeaderItem(9)
        ___qtablewidgetitem9.setText(QCoreApplication.translate("MainWindow", u"GPT3.5", None));
        ___qtablewidgetitem10 = self.dataTable.horizontalHeaderItem(10)
        ___qtablewidgetitem10.setText(QCoreApplication.translate("MainWindow", u"GPT3", None));
        self.fileGroupBox.setTitle(QCoreApplication.translate("MainWindow", u"\u6587\u4ef6", None))
